...
export function LoginForm() {
  ...
  const [email, setEmail] = useState("demo@karaoke.local");
  ...
  return (
    <form onSubmit={onSubmit} className="w-full max-w-md rounded-[2rem] border border-white/10 bg-black/30 p-8 shadow-glow">
      ...
      <p className="mt-3 text-sm text-white/60">Usa credenciales reales del backend o registra un usuario vía API.</p>
